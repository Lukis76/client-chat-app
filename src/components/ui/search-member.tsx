    ...
    <div className={cn('relative w-full bg-default-200/50 dark:bg-default/60', text && showResults ? 'rounded-t-large' : 'rounded-large')}>
      <Input
        ...
        classNames={{
          ...
          inputWrapper: cn(
            'shadow-xl bg-default-200/50 dark:bg-default/60 backdrop-blur-xl backdrop-saturate-200 hover:bg-default-200/70 dark:hover:bg-default/70 group-data-[focused=true]:bg-default-200/50 dark:group-data-[focused=true]:bg-default/60 !cursor-text rounded-none',
            showResults ? 'rounded-t-large' : 'rounded-large'
          ),
          mainWrapper: cn(
            'shadow-xl bg-default-200/50 dark:bg-default/60 backdrop-blur-xl backdrop-saturate-200  group-data-[focused=true]:bg-default-200/50 dark:group-data-[focused=true]:bg-default/60 !cursor-text rounded-none',
            showResults ? 'rounded-t-large' : 'rounded-large'
          ),
        }}
